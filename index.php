...
<div id="body">
    ...
    <p class="paragraph lg:mx-48 md:mx-12 mx-3 my-6 text-lg xl:text-xl md:text-xl">
        Kekacauan terjadi dan banyak memakan korban jiwa pada hari itu (1 Oktober 2022). Kejadian ini dimulai karena
        Persebaya (Klub Sepak Bola Surabaya) melawan Arema (Klub Sepak Bola Malang). Kejadian baru-baru ini tidak hanya
        terjadi sekali dan pertama kali, namun kejadian bentrok antara fans Persebaya dan Aremania sudah terjadi
        berkali-kali. Namun, kebetulan pertandingan yang terjadi kemarin ini berlangsung di tuan rumah Arema, yaitu
        berada di stadion Kanjuruhan Malang itu sendiri. Pertandingan berlangsung dan menghasilkan skor 3 (Persebaya) -
        2 (Arema). Arema mengalami kekalahan.
        Namun, kedewasaan sangat kurang terjadi di dalam sebuah pertandingan ini. Dimulai dari 1 orang yang turun ke
        dalam lapangan dan berusaha berontak karena ketidak terimaannya terhadap kekalahan itu, lalu disusul dengan
        aremania dan aremanita lainnya, sehingga polisi tidak bisa mengendalikan aksi berontak ini dan terjadilah sebuah
        “perang” antara fans Arema kepada pemain sepak bola Persebaya (ilustrasi sebagai berikut).
    </p>
    <img class="mx-auto my-6 lg:w-[400px] md:w-[350px]" width="300px" src="/kanjuruhan/images/gif_canva_mitigasi_(1).gif">
    <p class="paragraph lg:mx-48 md:mx-12 mx-3 my-6 text-lg xl:text-xl md:text-xl">
        Banyak luka fisik, penderitaan, bahkan sampai kehilangan nyawa terjadi dalam pertandingan tersebut. Polisi
        sontak berinisiatif untuk menghentikan massa, dengan cara menyemprotkan gas ai mata yang bisa membahayakan
        banyak orang dan menimbulkan banyak kematian pada akhirnya (ilustrasi di bawah).
    </p>
    <img class="mx-auto my-6 lg:w-[400px] md:w-[350px]" width="300px" src="/kanjuruhan/images/gif_canva_mitigasi_(2).gif">
    <p class="paragraph lg:mx-48 md:mx-12 mx-3 my-6 text-lg xl:text-xl md:text-xl">
        Tak hanya itu, tidak tahu motif apa yang mendorong polisi ini, mereka juga menutup seluruh pintu akses stadion
        sehingga orang di dalam stadion tidak dapat keluar ke luar stadion (ilustrasi di bawah ini).
    </p>
    <img class="mx-auto my-6 lg:w-[600px] md:w-[450px]" width="300px" src="/kanjuruhan/images/pintu12_pintu13.png">
    <p class="paragraph lg:mx-48 md:mx-12 mx-3 my-6 text-lg xl:text-xl md:text-xl">
        Misteri dibalik pintu stadion 13. Investigasi PSSI menemukan pintu 13 ini tidak terbuka walaupun pertandingan
        telah usai, padahal pada dasarnya peraturan pertandingan dinyatakan bahwa 10 menit sebelum pertandingan usai,
        pintu harus dibuka. Penonton sepak bola bersaksi bahwa pintu 13 ini seperti kuburan massal, puluhan orang
        meninggal di pintu 13 ini, manusia-manusianya bertumpukan dan tergeletak tak bernyawa. Dikarenakan pintu
        tertutup rapat, massa terpaksa harus merusak dan membobol tembok stadion untuk bisa keluar dari stadion dan
        selamat dari tembakan gas air mata.
    </p>
    <img class="mx-auto my-6 lg:w-[600px] md:w-[450px]" width="300px" src="/kanjuruhan/images/pintu13.png">
    <p class="paragraph lg:mx-48 md:mx-12 mx-3 my-6 text-lg xl:text-xl md:text-xl">
        Selain hebohnya massa yang saling memprovokasi satu sama lain untuk terjun ke dalam lapangan dan menimbulkan
        adanya “peperangan” hingga kematian, jika ditelusuri lebih dalam akar permasalahannya, tidak hanya sekedar
        manusia-manusia yang beraktivitas di waktu itu saja yang bersalah, namun juga mengenai bentuk stadion, denah,
        dan bahkan hal sedetail arsitektur dari bangunan stadion kanjuruhan ini. Terlihat simple, namun jika sebuah
        bangunan atau sesuatu yang digunakan oleh manusia didesain dengan sembarangan dan tidak mempertimbangkan bibit
        bobot bebetnya, serta tidak mempertimbangkan resiko-resiko apa saja yang akan terjadi apabila terjadi suatu
        kekacauan atau bahkan bentrok seperti kejadian kanjuruhan lalu.
    </p>
    <p class="paragraph lg:mx-48 md:mx-12 mx-3 my-6 text-lg xl:text-xl md:text-xl">
        Komparasikan antara stadion di negara Indonesia, dengan stadion dengan spesifikasi FIFA (persepakbolaan
        internasional dan peraturan internasional dari cabang olahraga sepak bola).
    </p>
